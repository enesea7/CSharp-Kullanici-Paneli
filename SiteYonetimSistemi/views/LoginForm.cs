    ...
    public partial class LoginForm : Form
    {
        ...
        private void btnGiris_Click(object sender, EventArgs e)
        {
            ...
            if (girisYapan != null)
            {
                ...
                else if (girisYapan.Rol == "Sakin")
                {
                    MessageBox.Show("Site Sakini paneli henüz tasarlanmadı. Yakında eklenecek!", "Bilgi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                }
